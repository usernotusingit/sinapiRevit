...
**Grand total: R$ 3,026,403.17**

## R$ by match confidence

| confidence | R$ | % of total |
|---|---:|---:|
| high | 398,601.25 | 13.2% |
| medium | 2,493,449.21 | 82.4% |
| low | 134,352.71 |  4.4% |

> **high** = reviewed/strong match · **medium** = grupo/thickness-anchored (semantically bounded, unit-checked) · **low** = verify. Only 4.4% of the total rests on low-confidence matches; 17 items are explicit gaps (excluded, priced manually).

## By chapter

| chapter | items | R$ |
|---|---:|---:|
| Estrutura | 7 | 1,081,552.48 |
| Vedações | 52 | 657,927.44 |
| Acabamentos | 67 | 485,847.58 |
| Cobertura | 2 | 470,413.44 |
| Esquadrias | 47 | 141,452.11 |
| Hidrossanitário | 11 | 114,091.38 |
| Circulação | 13 | 75,118.74 |
